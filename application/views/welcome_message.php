...
<section class='container'>
          <hgroup>
            <h1>Welcome to your CodeIgniter application on OpenShifssst</h1>
          </hgroup>
...
$ git push</pre>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
			  <section class="codeigniter">
				...
				<p>If you would like to edit this page you'll find it located at: <br><code>application/views/welcome_message.php</code></p>
				<p>The corresponding controller for this page is found at: <br><code>application/controllers/Welcome.php</code></p>
			  </section>
                ...
                <p>Installing the <a href="https://developers.openshift.com/en/managing-client-tools.html">OpenShift RHC client tools</a> allows you complete control of your cloud environment. Read more on how to manage your application from the command line in our <a href="https://www.openshift.com/user-guide">User Guide</a>.</p>
		...
		<div class="row">
			<section class="col-xs-12">
				<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?= (ENVIRONMENT === 'development' || ENVIRONMENT === 'local') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
			</section>
        </div>
